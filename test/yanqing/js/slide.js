...
(function(c) {
	...
	(function(g, e, h) {
        ...
        e.using("UI").Path = f
    })(jQuery, yuuk); (function b() {
        var e = d.Path($("<div></div>").appendTo("#j-focusPic").hide(), {
            button: [[[0, 43], "i-menu", "播放", "#"], [[20, -41], "i-ipad", "ipad版", "http://www.17sucai.com"], [[60, -23], "i-iphone", "iphone版", "http://www.17sucai.com"], [[76, 14], "i-tv", "TV版", "http://www.17sucai.com"], [[68, 51], "i-pc", "乐视网络电视", "http://www.17sucai.com"]]
        });
